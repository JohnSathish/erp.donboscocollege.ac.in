...
@Component({
    ...
    imports: [SelectModule,RouterLink,BsDatepickerModule,CustomPaginationComponent,CommonModule,FormsModule,MatSortModule,DateRangePickerComponent,TooltipContentComponent]
})
