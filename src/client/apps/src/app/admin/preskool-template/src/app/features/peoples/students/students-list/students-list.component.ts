...
@Component({
    ...
    imports: [BsDatepickerModule,SelectModule,FormsModule,RouterLink,CustomPaginationComponent,CommonModule,MatSortModule,DateRangePickerComponent,TooltipContentComponent]
})
