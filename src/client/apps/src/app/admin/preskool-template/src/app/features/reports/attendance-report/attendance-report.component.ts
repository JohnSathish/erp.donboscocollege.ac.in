...
import { attendanceReport, apiResultFormat, pageSelection } from '../../../shared/model/pages.model';
...
export class AttendanceReportComponent {
  ...
  public tableData: Array<attendanceReport> = [];
  public pageSize = 10;
  ...
  public tableDataCopy: Array<attendanceReport> = [];
  public actualData: Array<attendanceReport> = [];
  //** pagination variables
  initChecked = false;
