...
import { countries, apiResultFormat, pageSelection } from '../../../../shared/model/pages.model';
...
export class CountriesComponent {
  ...
  public tableDataCopy: Array<countries> = [];
  public actualData: Array<countries> = [];
  //** pagination variables
  initChecked = false;
  ...
  constructor(
    ...
    this.data.getCountries().subscribe((apiRes: apiResultFormat) => {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getCountries().subscribe((apiRes: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<countries>(this.actualData);
