...
import { apiResultFormat, pageSelection, expenseData } from '../../../shared/model/pages.model';
...
export class ExpensesComponent {
  ...
  initChecked = false;
  public pageSize = 10;
  public tableData: Array<expenseData> = [];
  public tableDataCopy: Array<expenseData> = [];
  public actualData: Array<expenseData> = [];
  ...
  constructor(
    ...
    this.data.getExpenceData().subscribe((apiRes: apiResultFormat) => {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getExpenceData().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: expenseData, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<expenseData>(this.actualData);
