...
import { feesCollectData, apiResultFormat } from '../../../../shared/model/pages.model';
...
export class CollectFeesComponent {
  ...
  initChecked = false;
  public pageSize = 10;
  public tableData: Array<feesCollectData> = [];
  public tableDataCopy: Array<feesCollectData> = [];
  public actualData: Array<feesCollectData> = [];
  ...
  dataSource!: MatTableDataSource<feesCollectData>;
  ...
  constructor(
    ...
    this.data.getFeesCollect().subscribe((apiRes: apiResultFormat) => {
      this.actualData = apiRes.data;
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.collectFees) {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getFeesCollect().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: feesCollectData, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<feesCollectData>(this.actualData);
