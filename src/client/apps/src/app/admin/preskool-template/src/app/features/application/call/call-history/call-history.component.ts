...
import { apiResultFormat, callHistory, pageSelection } from '../../../../shared/model/pages.model';
...
@Component({
    ...
    imports: [CommonModule,NgScrollbarModule,RouterLink,CustomPaginationComponent,FormsModule,MatSortModule]
})
