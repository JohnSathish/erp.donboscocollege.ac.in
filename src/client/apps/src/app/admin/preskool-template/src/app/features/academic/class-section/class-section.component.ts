...
import { classSectionData, apiResultFormat } from '../../../shared/model/pages.model';
...
export class ClassSectionComponent {
  ...
  initChecked = false;
  public pageSize = 10;
  public tableData: Array<classSectionData> = [];
  public tableDataCopy: Array<classSectionData> = [];
  public actualData: Array<classSectionData> = [];
  ...
  dataSource!: MatTableDataSource<classSectionData>;
  ...
  constructor(
    ...
    this.data.getClassSection().subscribe((apiRes: apiResultFormat) => {
      this.actualData = apiRes.data;
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.classSection) {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getClassSection().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: classSectionData, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<classSectionData>(this.actualData);
