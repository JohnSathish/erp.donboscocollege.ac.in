...
@Component({
    ...
    imports: [RouterLink,CustomPaginationComponent,MatSortModule,CommonModule,FormsModule,SelectModule,DateRangePickerComponent,TooltipContentComponent,BsDatepickerModule]
})
