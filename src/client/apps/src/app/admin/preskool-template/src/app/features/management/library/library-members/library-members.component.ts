...
import { libraryMemberList, apiResultFormat } from '../../../../shared/model/pages.model';
...
export class LibraryMembersComponent {
  ...
  initChecked = false;
  public pageSize = 10;
  public tableData: Array<libraryMemberList> = [];
  public tableDataCopy: Array<libraryMemberList> = [];
  public actualData: Array<libraryMemberList> = [];
  ...
  dataSource!: MatTableDataSource<libraryMemberList>;
  ...
  constructor(
    ...
    this.data.getLibraryMemberList().subscribe((apiRes: apiResultFormat) => {
      this.actualData = apiRes.data;
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.libraryMembers) {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getLibraryMemberList().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: libraryMemberList, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<libraryMemberList>(this.actualData);
