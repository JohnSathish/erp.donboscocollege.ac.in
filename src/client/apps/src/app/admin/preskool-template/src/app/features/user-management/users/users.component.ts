...
import { apiResultFormat, users } from '../../../shared/model/pages.model';
...
@Component({
    ...
    imports: [RouterLink,CustomPaginationComponent,FormsModule,MatSortModule,SelectModule,DateRangePickerComponent,TooltipContentComponent]
})
export class UsersComponent {
  initChecked = false;
  public pageSize = 10;
  public tableData: Array<users> = [];
  public tableDataCopy: Array< users> = [];
  public actualData: Array< users> = [];
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getUsers().subscribe((apiRes: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource< users>(this.actualData);
