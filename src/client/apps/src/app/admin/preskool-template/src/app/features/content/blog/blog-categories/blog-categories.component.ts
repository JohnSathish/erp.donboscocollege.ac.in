...
import { blogCategories, apiResultFormat, pageSelection } from '../../../../shared/model/pages.model';
...
export class BlogCategoriesComponent {
  ...
  public tableData: Array<blogCategories> = [];
  public pageSize = 10;
  ...
  public tableDataCopy: Array<blogCategories> = [];
  public actualData: Array<blogCategories> = [];
  //** pagination variables
  initChecked = false;
