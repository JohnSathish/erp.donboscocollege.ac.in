...
import { LeaveReport, apiResultFormat } from '../../../shared/model/pages.model';
...
export class LeaveReportComponent {
  ...
  initChecked = false;
  public pageSize = 10;
  public tableData: Array<LeaveReport> = [];
  public tableDataCopy: Array<LeaveReport> = [];
  public actualData: Array<LeaveReport> = [];
