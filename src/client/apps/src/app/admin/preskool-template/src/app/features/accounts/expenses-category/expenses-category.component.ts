...
import { apiResultFormat, pageSelection, expenseCategoryData } from '../../../shared/model/pages.model';
...
export class ExpensesCategoryComponent {
  ...
  initChecked = false;
  public pageSize = 10;
  public tableData: Array<expenseCategoryData> = [];
  public tableDataCopy: Array<expenseCategoryData> = [];
  public actualData: Array<expenseCategoryData> = [];
  ...
  dataSource!: MatTableDataSource<expenseCategoryData>;
  ...
  constructor(
    ...
    this.data.getExpenceCategoryData().subscribe((apiRes: apiResultFormat) => {
      this.actualData = apiRes.data;
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.expensesCategory) {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getExpenceCategoryData().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: expenseCategoryData, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<expenseCategoryData>(this.actualData);
