...
import { scheduleClass, apiResultFormat } from '../../../../shared/model/pages.model';
...
export class ScheduleClassesComponent {
  ...
  initChecked = false;
  public pageSize = 10;
  public tableData: Array<scheduleClass> = [];
  public tableDataCopy: Array<scheduleClass> = [];
  public actualData: Array<scheduleClass> = [];
  ...
  dataSource!: MatTableDataSource<scheduleClass>;
  ...
  constructor(
    ...
    this.data.getScheduleClass().subscribe((apiRes: apiResultFormat) => {
      this.actualData = apiRes.data;
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.scheduleClasses) {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getScheduleClass().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: scheduleClass, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<scheduleClass>(this.actualData);
