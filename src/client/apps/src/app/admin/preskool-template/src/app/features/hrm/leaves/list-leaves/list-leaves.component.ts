...
import { listLeaves, apiResultFormat } from '../../../../shared/model/pages.model';
...
export class ListLeavesComponent {
  ...
  initChecked = false;
  public pageSize = 10;
  public tableData: Array<listLeaves> = [];
  public tableDataCopy: Array<listLeaves> = [];
  public actualData: Array<listLeaves> = [];
  ...
  dataSource!: MatTableDataSource<listLeaves>;
  ...
  constructor(
    ...
    this.data.getListLeaves().subscribe((apiRes: apiResultFormat) => {
      this.actualData = apiRes.data;
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.listLeaves) {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getListLeaves().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: listLeaves, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<listLeaves>(this.actualData);
