export const routes ={
  ...
  editTeacher: '/teachers/edit-teacher',
  teacherRoutine: '/teachers/teachers-routine',
  teacherLeaves: '/teachers/teacher-leaves',
  teacherSalary: '/teachers/teacher-salary',
  teachersList: '/teachers/teachers-list',
  teacherGrid: '/teachers/teacher-grid',
  teacherDetails: '/teachers/teacher-details',
  teacherLibrary: '/teachers/teacher-library',

  // Students//
  addStudent: '/students/add-student',
  editStudent: '/students/edit-student',
  studentDetails: '/students/student-details',
  studentFees: '/students/student-fees',
  studentLeaves: '/students/student-leaves',
  studentList: '/students/students-list',
  studentsList: '/students/students-list',
  studentsGrid: '/students/student-grid',
  studentGrid: '/students/student-grid',
  studentPromotion: '/students/student-promotion',
  studentLibrary: '/students/student-library',
  studentTimeTable: '/students/student-time-table',
  ...
  // Attendance//
  teacherAttendance: '/attendance/teacher-attendance',
  staffAttendance: '/attendance/staff-attendance',
  staffsAttendance: '/attendance/staffs-attendance',
  studentAttendance: '/attendance/student-attendance',
  ...
  collectFees: '/fees-collection/collect-fees',
  feesAssign: '/fees-collection/fees-assign',
  players: '/players',
  sports: '/sports',
