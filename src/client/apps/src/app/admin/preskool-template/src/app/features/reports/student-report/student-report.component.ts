...
import { studentReport, apiResultFormat } from '../../../shared/model/pages.model';
...
export class StudentReportComponent {
  ...
  initChecked = false;
  public pageSize = 10;
  public tableData: Array<studentReport> = [];
  public tableDataCopy: Array<studentReport> = [];
  public actualData: Array<studentReport> = [];
  ...
  dataSource!: MatTableDataSource<studentReport>;
  ...
  constructor(
    ...
    this.data.getStudentReports().subscribe((apiRes: apiResultFormat) => {
      this.actualData = apiRes.data;
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.studentReport) {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getStudentReports().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: studentReport, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<studentReport>(this.actualData);
