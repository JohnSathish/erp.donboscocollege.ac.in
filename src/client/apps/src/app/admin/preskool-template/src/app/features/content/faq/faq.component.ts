...
import { faqData, apiResultFormat } from '../../../shared/model/pages.model';
...
export class FaqComponent {
  ...
  initChecked = false;
  public pageSize = 10;
  public tableData: Array<faqData> = [];
  public tableDataCopy: Array<faqData> = [];
  public actualData: Array<faqData> = [];
  ...
  dataSource!: MatTableDataSource<faqData>;
  public searchDataValue = '';
  textAreaValue: string = 'You can reset your password from the login page.';
  textAreaValue2: string = 'How do I reset my password?';
  constructor(
    ...
    this.data.getFaqData().subscribe((apiRes: apiResultFormat) => {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getFaqData().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: faqData, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<faqData>(this.actualData);
