...
import { blogComments, apiResultFormat, pageSelection } from '../../../../shared/model/pages.model';
...
export class BlogCommentsComponent {
  ...
  public tableDataCopy: Array<blogComments> = [];
  public actualData: Array<blogComments> = [];
  //** pagination variables
  initChecked = false;
