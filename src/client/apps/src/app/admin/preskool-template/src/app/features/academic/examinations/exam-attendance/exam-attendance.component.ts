...
import { examAttendance, apiResultFormat } from '../../../../shared/model/pages.model';
...
@Component({
    ...
    imports: [SelectModule,RouterLink,CustomPaginationComponent,CommonModule,FormsModule,MatSortModule,DateRangePickerComponent,TooltipContentComponent]
...
export class ExamAttendanceComponent {
  ...
  initChecked = false;
  public pageSize = 10;
  public tableData: Array<examAttendance> = [];
  public tableDataCopy: Array<examAttendance> = [];
  public actualData: Array<examAttendance> = [];
  ...
  dataSource!: MatTableDataSource<examAttendance>;
  ...
  constructor(
    ...
    this.data.getExamAttedance().subscribe((apiRes: apiResultFormat) => {
      this.actualData = apiRes.data;
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.examAttendance) {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getExamAttedance().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: examAttendance, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<examAttendance>(this.actualData);
