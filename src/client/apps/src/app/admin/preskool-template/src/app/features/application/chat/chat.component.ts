import { AfterViewChecked, Component, OnDestroy, Renderer2 } from '@angular/core';
...
@Component({
    ...
    imports: [LightgalleryModule,RouterLink,NgScrollbarModule,CommonModule]
})
export class ChatComponent implements AfterViewChecked, OnDestroy {
  ...
  ngOnDestroy(): void {
    this.renderer.removeClass(document.body, 'main-chat-blk');
  }
}
